...
export default class StudentOrgs extends Component {
    ...
    handleSubmit(event) {
        ...
        fetch('https://hackathon-singularity-backend.herokuapp.com/sorg/' + this.state.name)
        .then(res => res.json())
        .then(json => {
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                fetch('https://hackathon-singularity-backend.herokuapp.com/sorg/details/' + json[i]["uri"])
                .then(res2 => res2.json())
                .then(json2 => {
